...
import account.fpoly.s_shop_client.Activity.AddCommentActivity;
...
public class NestesCommentAdapter extends RecyclerView.Adapter<NestesCommentAdapter.NestesViewHolder>{
    ...
    String id;
    @Override
    public void onBindViewHolder(@NonNull NestesViewHolder holder, @SuppressLint("RecyclerView") int position) {
