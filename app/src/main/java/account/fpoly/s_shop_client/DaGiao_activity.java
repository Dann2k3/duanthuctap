...
public class DaGiao_activity extends AppCompatActivity {
    ...
    private void hienthiHistoty() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, API.api + "billStatus?id_user=" + iduser + "&status=3", null, new Response.Listener<JSONObject>() {
            @Override
