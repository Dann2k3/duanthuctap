...
public class HuyBill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_huy_bill);
    ...
    private void hienthiHistoty() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, API.api + "billStatus?id_user=" + iduser + "&status=4", null, new Response.Listener<JSONObject>() {
            @Override
