...
public class MuaProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (ContextCompat.checkSelfPermission(MuaProduct.this, android.Manifest.permission.POST_NOTIFICATIONS) !=
...
//        Toast.makeText(this, "price: "+ total_product, Toast.LENGTH_SHORT).show();
    ...
    private void layDulieu() {
        ...
        Log.d("imaaaaageeeeee", imagePro != null ? imagePro : "Image is null");
